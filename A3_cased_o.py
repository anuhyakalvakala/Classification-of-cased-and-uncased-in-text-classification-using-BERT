...
def train_test() :
    ...
    maxTrEg=20 # maximum number of pos & neg training examples
    maxTeEg=20# maximum number of pos & neg test examples

    # read the data
    #train_x, train_y = readPosNeg("archive/train/pos","archive/train/neg",maxTrEg)
    test_x, test_y = readPosNeg("archive/test/pos","archive/test/neg",maxTeEg)
    ...
    return model, test_y #[tokenized_train["input_ids"],tokenized_train["attention_mask"]]
